...
<<<<<<< HEAD
    for seasonality in ['Hourly','Daily','Weekly','Quarterly','Yearly','Monthly'][4:]:
=======
    for seasonality in ['Hourly','Daily','Weekly','Quarterly','Yearly','Monthly'][5:]:
>>>>>>> b07416a52a23dce6f2151962cda7d132e1193fd9
        # seasonality = 'Daily'
